...
router.post('/search',function(req,res){
    ...
    mongoClient.connect('mongodb://localhost:27017/billing_final', function(err, db) {
      ...
      console.log(req.body.patient_info)
      console.log(typeof(req.body.patient_info))
     ...
     // if(result[0]["surname"]!="" && result[0]["city"]!="" && result[0]["address"] !="" && result["e_mail"]!=""){
          console.log("================result====================")
